...
import { orders, products } from '../../assets/schemas';
        ...
        <Fragment>
            ...
            <section className='page flexcol center'>
                ...
                <section className='orderCont'>
                    ...
                    <section className='youMayAlso'>
                        <article className='flex center wh'><h1 className='headingSmol'>You May Also Like</h1></article>
                        <article className='ymalProducts'>
                            {
                                products && products.length > 0 && products.slice(0, 6).map((pro, index) => (
                                    <Fragment key={index}>
                                        <SmallCard name={pro.name} id={pro.productId} image={pro.image ? pro.image : defaulImg} salePrice={pro.salePrice} />
                                    </Fragment>
                                ))
                            }
                        </article>
