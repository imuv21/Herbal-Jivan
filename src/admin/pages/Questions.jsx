            ...
            <article className='usersList'>
                ...
                {questsAdmin && questsAdmin.length > 0 && questsAdmin.map((question, index) => (
                    <div className="userRow" key={index}>
                        ...
                        <div className="seeBtns"> <button onClick={handleClickFooter}>Reply</button> <button onClick={() => seeProduct(question.productId)}>See Product</button> <button>Delete</button> </div>
                    </div>
                ))}
            </article>
